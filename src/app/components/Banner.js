        ...
        >
          ...
          <MouseParallaxChild factorX={0.05} factorY={0.1}>
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 px-6 lg:px-0 max-w-2xl">
              ...
              {/* Primary Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bangers text-white drop-shadow-lg leading-snug mb-6">
                Where Every Bite
                <span className="block text-secondary mt-2">Arrives Perfect.</span>
              </h1>

              {/* Subtext */}
              <p className="text-white/80 text-lg lg:text-xl font-robotoCondensed mb-8 max-w-sm lg:max-w-lg mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="group relative h-16 px-8 bg-primary hover:bg-primaryHover text-white font-bold text-lg rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-primary/50 flex items-center justify-center gap-2"
                >
                  <span>Order Now</span>
          ...
          <MouseParallaxChild factorX={0.15} factorY={0.2} className="relative flex-1 flex justify-center lg:justify-end mb-12 lg:mb-0">
